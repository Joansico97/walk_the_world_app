...
final authProvider = Provider((ref) => _AuthProvider(authResource: ref.read(authResource)));

class _AuthProvider implements AuthRepository {
  _AuthProvider({required AuthResource authResource}) : _authResource = authResource;

  final AuthResource _authResource;
  @override
  Either<ApiException, String?> getCurrentUser() => _authResource.getCurrentUser();
