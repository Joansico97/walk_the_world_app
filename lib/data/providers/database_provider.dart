...
final databaseProvider = Provider((ref) => _DatabaseProvider(databaseResource: ref.read(databaseResource)));

class _DatabaseProvider implements DatabaseRepository {
  _DatabaseProvider({required DatabaseResource databaseResource}) : _databaseResource = databaseResource;
  ...
  @override
  Future<Either<ApiException, String>> deleteDocument({required String documentId, required String collection}) =>
      _databaseResource.deleteDocument(documentId: documentId, collection: collection);
  ...
  @override
  Future<Either<ApiException, String>> post({required Map<String, dynamic> document, required String table}) =>
      _databaseResource.post(document: document, table: table);

  @override
  Future<Either<ApiException, String>> updateDocument(
          {required String docId, required Map<String, dynamic> data, required String table}) =>
